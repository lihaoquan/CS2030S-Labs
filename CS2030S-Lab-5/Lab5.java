...
class Lab5 {
  public static String getGrade(String module, String student, String assessment,
    ...
    Constant<Actually<Map<String, Map<String, Map<String, String>>>>> DB_CONST = new Constant<>() {
    ...
    Constant<String> NO_SUCH_ENTRY = new Constant<>() {
      public String init() {
        return "No such entry";
      }
    };

    Immutator<Actually<Map<String, Map<String, String>>>, Map<String, Map<String, Map<String, String>>>> moduleImmutator = new Immutator<>() {
      @Override
      public Actually<Map<String, Map<String, String>>> invoke(
          Map<String, Map<String, Map<String, String>>> param) {
        return Actually.<Map<String, Map<String, String>>>ok(param.get(module));
      }
    };

    Immutator<Actually<Map<String, String>>, Map<String, Map<String, String>>> studentImmutator = new Immutator<>() {
      @Override
      public Actually<Map<String, String>> invoke(Map<String, Map<String, String>> map) {
        return Actually.<Map<String, String>>ok(map.get(student));
      }
    };

    Immutator<Actually<String>, Map<String, String>> assessmentImmutator = new Immutator<>() {
      @Override
      public Actually<String> invoke(Map<String, String> map) {
        return Actually.<String>ok(map.get(assessment).toString());
      }
    };

    return DB_CONST.init().next(moduleImmutator).next(studentImmutator).next(assessmentImmutator).except(NO_SUCH_ENTRY);
  }
